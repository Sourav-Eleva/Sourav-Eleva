...
public function open_pages()
{
	...
	//$count_user =  count($data['user_data']);
	...
	//echo $user_objective_count;
	//echo "<br>".$user_objective_page[0]."<br>";

	//exit;
	if(isset($user_objective_page[0]))
	{
		//echo "Count of pages:".$user_objective_count;
		// Job pages
		if($user_objective_page[0]=='Job') {
			$data['page_no'] = 1;
			if($user_objective_count==1)
			{
			$data['action_page'] = 'dashboard';
			} else {
			$data['action_page'] = $user_objective_page[1];
			}
		} else if($user_objective_page[1]=='Job') {
		$data['page_no'] = 2;
		$data['action_page'] = $user_objective_page[2];
		} else  if($user_objective_page[2]=='Job') {
		$data['page_no'] = 3;
		$data['action_page'] = $user_objective_page[3];
		// End job pages
		// Start hire pages
		if($user_objective_page[0]=='Hire') {
		$data['page_no'] = 1;
		if($user_objective_count==1)
		{
		$data['action_page'] = 'dashboard';
		...
		} else if($user_objective_page[1]=='Hire') {
		$data['page_no'] = 2;
		$data['action_page'] = $user_objective_page[2];
		} else  if($user_objective_page[2]=='Hire') {
		$data['page_no'] = 3;
		$data['action_page'] = $user_objective_page[3];
		// End hire pages
		// Start Collabrate pages
		if($user_objective_page[0]=='Collabrate') {
		$data['page_no'] = 1;
		if($user_objective_count==1)
		{
		$data['action_page'] = 'dashboard';
		...
		} else if($user_objective_page[1]=='Collabrate') {
		$data['page_no'] = 2;
		$data['action_page'] = $user_objective_page[2];
		} else  if($user_objective_page[2]=='Collabrate') {
		$data['page_no'] = 3;
		$data['action_page'] = $user_objective_page[3];
		// End Collabrate pages

		// Start Startups pages
		} else	if($user_objective_page[0]=='Startups') {
		$data['page_no'] = 1;
		if($user_objective_count==1)
		{
		$data['action_page'] = 'dashboard';
		...
		} else if($user_objective_page[1]=='Startups') {
		$data['page_no'] = 2;
		$data['action_page'] = $user_objective_page[2];
		} else if($user_objective_page[2]=='Startups') {
		$data['page_no'] = 3;
		$data['action_page'] = $user_objective_page[3];
		//}
		// End Startups pages
		// Start Investments pages
		} else	if($user_objective_page[0]=='Investments') {
		$data['page_no'] = 1;
		if($user_objective_count==1)
		{
		$data['action_page'] = 'dashboard';
		...
		} else if($user_objective_page[1]=='Investments') {
		$data['page_no'] = 2;
		$data['action_page'] = $user_objective_page[2];
		} else if($user_objective_page[2]=='Investments') {
		$data['page_no'] = 3;
		$data['action_page'] = $user_objective_page[3];
		//}
		// End Investments pages
		// Start Experts pages
		} else	if($user_objective_page[0]=='Experts') {
		$data['page_no'] = 1;
		if($user_objective_count==1)
		{
		$data['action_page'] = 'dashboard';
		...
		} else if($user_objective_page[1]=='Experts') {
		$data['page_no'] = 2;
		$data['action_page'] = $user_objective_page[2];
		} else if($user_objective_page[2]=='Experts') {
		$data['page_no'] = 3;
		$data['action_page'] = $user_objective_page[3];
		}
		// End Investments pages
		// Start Mentor pages
		} else	if($user_objective_page[0]=='Mentor') {
		$data['page_no'] = 1;
		if($user_objective_count==1)
		{
		$data['action_page'] = 'dashboard';
		...
		} else if($user_objective_page[1]=='Mentor') {
		$data['page_no'] = 2;
		$data['action_page'] = $user_objective_page[2];
		} else if($user_objective_page[2]=='Mentor') {
		$data['page_no'] = 3;
		$data['action_page'] = $user_objective_page[3];
		}
		// End Mentor pages
...
public function startups()
{
	...
	$user_objective_page = explode(",",$data['user_data']['0']->user_objective);
	$data['no_of_pages'] = $user_objective_count;
	if($user_objective_page[0]=='Startups')
	{
		$data['page_no'] = 1;
	} else if($user_objective_page[1]=='Startups') {
		$data['page_no'] = 2;
...
public function investments()
{
	...
	$user_objective_page = explode(",",$data['user_data']['0']->user_objective);
	$data['no_of_pages'] = $user_objective_count;
	if($user_objective_page[0]=='Investments')
	{
		$data['page_no'] = 1;
	} else if($user_objective_page[1]=='Investments') {
		$data['page_no'] = 2;
...
public function experts()
{
	...
	$user_objective_page = explode(",",$data['user_data']['0']->user_objective);
	$data['no_of_pages'] = $user_objective_count;
	if($user_objective_page[0]=='Experts')
	{
		$data['page_no'] = 1;
	} else if($user_objective_page[1]=='Experts') {
		$data['page_no'] = 2;
...
public function mentor()
{
	...
	$user_objective_page = explode(",",$data['user_data']['0']->user_objective);
	$data['no_of_pages'] = $user_objective_count;
	if($user_objective_page[0]=='Mentor')
	{
		$data['page_no'] = 1;
	} else if($user_objective_page[1]=='Mentor') {
		$data['page_no'] = 2;
